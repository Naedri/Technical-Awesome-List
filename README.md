...
#### palette - complementary color

- [CSS Color Palette Example | No Time Dad](https://www.notimedad.dev/css-color-palette/)
- [Complementary Color Picker | Giggster Guide](https://giggster.com/guide/complementary-colors/)
- [917 CSS Gradients | SheCodes](https://gradients.shecodes.io/)
- [1,671 CSS Color Palettes | SheCodes](https://palettes.shecodes.io/)
- [1,671 CSS Color Palettes | SheCodes](https://www.csscolorpalettes.com/)

#### youtube

- [10 CSS Pro Tips - Code this, NOT that! - YouTube](https://www.youtube.com/watch?t=432&v=Qhaz36TZG5Y&feature=youtu.be)
...
- [A Complete Guide to Data Attributes | CSS-Tricks - CSS-Tricks](https://css-tricks.com/a-complete-guide-to-data-attributes/#aa-styling-with-data-attributes)
- [A Couple of Use Cases for Calc() | CSS-Tricks - CSS-Tricks](https://css-tricks.com/a-couple-of-use-cases-for-calc/)
- [Une analyse approfondie de CSS-in-JS | Astuces CSS - Astuces CSS](https://css-tricks.com/a-thorough-analysis-of-css-in-js/)
- [Properties | CSS-Tricks - CSS-Tricks](https://css-tricks.com/almanac/properties/)
- [:focus-within | CSS-Tricks - CSS-Tricks](https://css-tricks.com/almanac/selectors/f/focus-within/)
- [BEM 101 | CSS-Tricks - CSS-Tricks](https://css-tricks.com/bem-101/)
- [Creating Color Themes With Custom Properties, HSL, and a Little calc() | CSS-Tricks - CSS-Tricks](https://css-tricks.com/creating-color-themes-with-custom-properties-hsl-and-a-little-calc/)
- [Guides Archive - CSS-Tricks Archive - CSS-Tricks](https://css-tricks.com/guides/)
- [Font Size Idea: px at the Root, rem for Components, em for Text Elements | CSS-Tricks - CSS-Tricks](https://css-tricks.com/rems-ems/)
...
- [Understanding the Web Content Accessibility Guidelines - Accessibilité | MDN](https://developer.mozilla.org/fr/docs/Web/Accessibility/Understanding_WCAG)
- [Understanding the Web Content Accessibility Guidelines - Accessibility | MDN](https://developer.mozilla.org/en-US/docs/Web/Accessibility/Understanding_WCAG#the_four_principles)
- [CSS selectors - CSS: Cascading Style Sheets | MDN](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Selectors)
- [Valeurs et unités CSS - Apprendre le développement web | MDN](https://developer.mozilla.org/fr/docs/Learn/CSS/Building_blocks/Values_and_units)
...
- [Cours : TIAS2U17 Base de données S2](https://moodle.parisdescartes.fr/course/view.php?id=14937)
- [SQL Server Date Functions Overview](https://www.sqlservertutorial.net/sql-server-date-functions/)
- [PL/SQL - IF-THEN-ELSIF Statement - Tutorialspoint](https://www.tutorialspoint.com/plsql/plsql_if_then_elsif.htm)
- [PL/SQL pour les développeurs | Oracle France](https://www.oracle.com/fr/database/technologies/appdev/plsql.html)
- [Guide PL/SQL](https://sheikyerbouti.developpez.com/pl_sql/)
...
- [Affecter par décomposition - JavaScript | MDN](https://developer.mozilla.org/fr/docs/Web/JavaScript/Reference/Operators/Destructuring_assignment#décomposer_les_propriétés_dobjets_passés_en_arguments)
- [Syntaxe de décomposition - JavaScript | MDN](https://developer.mozilla.org/fr/docs/Web/JavaScript/Reference/Operators/Spread_syntax)
- [Affecter par décomposition - JavaScript | MDN](https://developer.mozilla.org/fr/docs/Web/JavaScript/Reference/Operators/Destructuring_assignment#les_noms_de_propriétés_calculés_et_la_décomposition)
